  ...
  const api = new Api(stack, "api", {
    ...
    routes: {
      ...
      "GET /get-interview/{interviewId}":
        "packages/functions/src/get-interview.handler",
      ...
      "POST /begin-interview/{interviewId}":
        "packages/functions/src/begin-interview.handler",
      "POST /add-answer/{interviewId}":
        "packages/functions/src/add-answer.handler",
      "POST /finish-interview/{interviewId}":
        "packages/functions/src/finish-interview.handler",
    },
  });
